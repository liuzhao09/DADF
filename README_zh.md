...
参数量与对应的 Backbone+DADF 在 0.1% 误差内匹配。该对照不使用任何额外
特征、标签或训练样本，从而将“参数量增加”与“DADF 结构设计”分离。
...
且七个 backbone 中有四个没有提升。该对照表明，单纯扩大参数量不足以解释
DADF 的稳定增益，其效果依赖于额外容量如何被组织为分布感知纠偏结构。
